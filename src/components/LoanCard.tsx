...
const LoanCard: React.FC<LoanCardProps> = ({
  ...
  return (
    <article className="card overflow-hidden rounded-xl transition-all duration-300 hover:shadow-md" style={{ borderColor: 'hsl(var(--border))' }}>
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="mt-3 sm:mt-4">
          <div className="w-full rounded-full h-2" style={{ backgroundColor: 'hsl(var(--input))' }}>
            <div
        ...
        <div className="mt-4 sm:mt-6">
          <button className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 sm:py-3 text-sm font-medium rounded-lg text-white transition-all duration-200 hover:shadow-md"
